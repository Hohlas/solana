...
if [ ! -f "$RATE_FILE" ]; then
    echo "Time;p2010;p8000;p8001;p8899;tcp_in;tcp_out;udp_in;udp_out" > "$RATE_FILE"
fi
...
monitor_rates() {
    while true; do
        ...
        echo "$time;${rates[p2010]};${rates[p8000]};${rates[p8001]};${rates[p8899]};${rates[tcp_in]};${rates[tcp_out]};${rates[udp_in]};${rates[udp_out]}" >> "$RATE_FILE"
