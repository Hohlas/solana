...
- Переключение голосования с основного на резервный сервер происходит при отсутствии отставания резервной ноды и наступлении одного из трех событий:
  1. Статус "Delinquent" голосующей ноды
  2. Превышение 'behind' голосующей ноды порогового значения X, если guard запущен с аргументом 'guard X'.
  3. Наличие флага "permanent_primary", если guard запущен с аргументом 'guard p'.
